    ...
    for episode in range(n_episodes): 
        ...
        if (episode + 1) % episodes == 0:
            ...
            if solve_rate >= 90 and scramble != 12:
                q_table_filename = f'q_table_scramble_{scramble}_solve_rate_{solve_rate:.2f}_avg_steps_{solve_steps:.2f}_of.npy'
            ...
            save_history(avg_reward, avg_steps, solve_rate, solve_steps, 'history_of.json')
